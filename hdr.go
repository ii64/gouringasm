...
func (u *IoUringSqe_Union2) SetAddr_Value(v uint64)     { putUint64(unsafe.Pointer(u), v) }
func (u *IoUringSqe_Union2) SetAddr(v unsafe.Pointer)   { putUnsafe(unsafe.Pointer(u), v) }
func (u *IoUringSqe_Union2) SetSpliceOffsetIn(v uint64) { putUint64(unsafe.Pointer(u), v) }
